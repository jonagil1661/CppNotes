...
int main() {
  ...
  */
  ...
  int xx;
  cout << "Type another number: ", cin >> xx,
      cout << "Your number is: " << xx << endl;
  ...
  */
  ...
  cout << "5 < 3 is: " << (5 < 3)
       << endl;  // doesn't return true but rather in binary.
  cout << "5 == 5 is: " << (5 == 5)
       << endl;  // need to paranthesize the comparison expression in cout
