...
using namespace std;  // we can use names for objects and variables from the
                      // standard library.

int main() {  // function called main
  std::cout << "Hello, world!"
            << std::endl;  // cout is pronounced "see-out". An object used to
                           // output/print text.

  // if you omit the 3rd line 'namespace std;', then you have to use the std
  // keyword in line 6: 'cout << "Hello, world!" << std::endl;'

  cout << "Another line of stuff"
       << endl;  // since we're using namespace std, we don't have to use
                 // 'std::' all the time
